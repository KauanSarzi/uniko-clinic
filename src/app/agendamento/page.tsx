          ...
          <div className="flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-5 p-6 sm:p-8 rounded-card bg-vinho">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-3 w-full sm:w-auto px-8 py-4 rounded-pill bg-[#25D366] text-white font-sans font-semibold hover:shadow-glow hover:scale-105 transition-all duration-200"
              >
