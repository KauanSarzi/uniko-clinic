...
export default function DiferencialCard({ diferencial }: DiferencialCardProps) {
  return (
    <div className="flex flex-col items-center text-center gap-4 p-6 rounded-card bg-nude shadow-card hover:shadow-card-hover transition-shadow duration-300">
      {/* Ícone dourado */}
      <div className="w-14 h-14 rounded-full bg-gold-gradient flex items-center justify-center text-vinho shrink-0">
