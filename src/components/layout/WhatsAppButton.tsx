...
export default function WhatsAppButton() {
  ...
  if (pathname.startsWith('/tratamentos/')) {
    const slug = pathname.slice('/tratamentos/'.length)
    nomeTratamento = getTratamentoBySlug(slug)?.nome
  }
  ...
  return (
    ...
    >
      ...
      <span className="hidden sm:block pr-5 font-sans text-sm font-medium whitespace-nowrap">
        Falar pelo WhatsApp
      </span>
    </a>
  )
